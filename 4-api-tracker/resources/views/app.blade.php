...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <button onclick="setChannel()">Track device</button>
        <div id="erro"></div>
        <div id="map"></div>

        <script src="{{ asset('js/app.js') }}"></script>
        <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDT8lYKUF-_XNauMHAA9xVRj7GSCNAGNHQ&callback=initMap&v=weekly"
        async
        ></script>
        ...
        <script>
            ...
            function setChannel()
            {
                const elem = document.getElementById("modelo");
                const channel = elem.value

                if (window.previousChannel != undefined){
                    Echo.leaveChannel(window.previousChannel);
                }
